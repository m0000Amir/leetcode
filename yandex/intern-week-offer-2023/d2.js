    ...
    if (textBetweenPress.includes('[v]')) {
      ...
      if (textBetweenPress[0].toLowerCase() !== textBetweenPress[0].toUpperCase()) {
        if (textBetweenPress[0] === textBetweenPress[0].toLowerCase()) {
          output += addLetter(textBetweenPress[0].toLowerCase()).toLowerCase();
        } else {
          output += addLetter(textBetweenPress[0].toUpperCase()).toUpperCase();
        }
      } else {
...
let text2 = 'H[_]e[_][v]l[_]ll[_]o[_]\n' + '[_][l][l][_]v[_]bb[_]h';
